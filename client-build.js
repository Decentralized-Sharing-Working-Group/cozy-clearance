...
buf.push("<p>&nbsp;</p></div><p><!--span.public-url= t('or')--><!--| &nbsp;#{t('modal shared micropub msg')}--><p>" + (jade.escape(null == (jade_interp = t('modal shared micropub msg')) ? "" : jade_interp)) + "</p><input id=\"micropub-input\" type=\"text\"" + (jade.attr("placeholder", t('modal shared ' + type + ' custom micropub msg'), true, false)) + " autocomplete=\"off\" class=\"form-control\"/><a id=\"share-micropub\" class=\"btn btn-cozy\">Publish</a></p><p><span class=\"public-url\">" + (jade.escape(null == (jade_interp = t('or')) ? "" : jade_interp)) + "</span>&nbsp;" + (jade.escape((jade_interp = t('modal shared with people msg')) == null ? '' : jade_interp)) + "</p><form role=\"form\" class=\"input-group\"><input id=\"share-input\" type=\"text\"" + (jade.attr("placeholder", t('modal shared ' + type + ' custom msg'), true, false)) + " autocomplete=\"off\" class=\"form-control\"/><a id=\"add-contact\" class=\"btn btn-cozy\">Add</a></form><ul id=\"share-list\">");
if ( clearance != 'public')
{
// iterate clearance
;(function(){
...
module.exports = CozyClearanceModal = (function(superClass) {
  ...
  CozyClearanceModal.prototype.onMicropubClicked = function() {
    return console.log('micropub ' + this.$('#public-url').val() + ' to ' + this.$('#micropub-input').val());
  };
